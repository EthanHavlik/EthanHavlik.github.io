...
document.addEventListener("DOMContentLoaded", () => {
    const images = getElements("#carousel div img");
    ...
    document.querySelector("#next").addEventListener("click", evt => {
        let unseen = sources.shift();
        sources.push(unseen);
        unseen = alts.shift();
        alts.push(unseen);
        unseen = ctrlrNames.shift();
        ctrlrNames.push(unseen);
        unseen = ctrlrDescs.shift();
    ...
    document.querySelector("#previous").addEventListener("click", evt => {
        let unseen = sources.pop();
        sources.unshift(unseen);
        unseen = alts.pop();
        alts.unshift(unseen);
        unseen = ctrlrNames.pop();
        ctrlrNames.unshift(unseen);
        unseen = ctrlrDescs.pop();
